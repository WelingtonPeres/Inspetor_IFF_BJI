# Diagrama de Classes — Core, Infrastructure e Application

Visão de classes das camadas internas do projeto (a camada view, por ser extensa,
é documentada em [view.md](view.md)).
